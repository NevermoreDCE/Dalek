...
namespace PartXMLTest
{
    public partial class Form1 : Form
    {
        ...
        private void InitShip()
        {
            ...
            ship.HP.Max = 50;
            ship.HP.Current = 50;
            ship.Equipment.Add(new WeaponPart("Laser Beam", 1, 5, 2, 0, new List<IShipPartAction>()));
            ship.Equipment.Add(new WeaponPart("Laser Beam", 1, 5, 2, 0, new List<IShipPartAction>()));
            ship.Equipment.Add(new WeaponPart("Laser Beam", 1, 5, 2, 0, new List<IShipPartAction>()));
            ship.Equipment.Add(new WeaponPart("Laser Beam", 1, 5, 2, 0, new List<IShipPartAction>()));
            ...
            ship.Equipment.Add(new DefensePart("Shield Generator", 15, 1, "Down", "Penetrating", ShieldGenAction));
            ship.Equipment.Add(new DefensePart("Armor Plate", 15, 3, "Destroyed", "Shattering", new List<IShipPartAction>()));
